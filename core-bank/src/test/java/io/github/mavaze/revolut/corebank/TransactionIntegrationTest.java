package io.github.mavaze.corebank;
...
import io.github.mavaze.commons.domain.TransactionStatus;
import io.github.mavaze.commons.utils.NameIdGenerator;
import io.github.mavaze.commons.utils.TestUtils;
import io.github.mavaze.corebank.exceptions.ErrorMessage;
...
import static io.github.mavaze.commons.utils.TestUtils.*;
...
public class TransactionIntegrationTest extends JerseyTest {
    ...
    public void doIntraBankTransfer_Success() {
        ...
        createAndGetBank(this, bankCode1, "HDFC India");
